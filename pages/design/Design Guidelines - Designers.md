...
## Configuration Steps
On this part, it's more about what a personal preference for settings. In here people tweak the Dark/Light theme, the account, the mouse wheel direction etc. 
...
#### Pagination
Pagination set is presented by 4 Components:
- Hover
- Active
- Selected
- Disabled
