...
- **No error message?** Use `console.log` (or your language's equivalent) to print variables and check the state of your data at different points in the code.
- **Not a data issue?** Comment out lines of code one by one to find where things break. Then use `console.log` to dig deeper.
- **Check the docs** for the plugin, package, or language you're using. Compare your code to the official examples.
...
> Credit to this Reddit [post](https://www.reddit.com/r/webdev/comments/rw3rgd/im_lead_tech_at_an_agency_and_i_recently_wrote/) for inspiring this list.